...
public class SandPileGameTest {
    ...
    @Test
    void should_add_1_sand_grain_for_a_9_cells_with_3_grains_at_center_and_3_grains_on_top() {
        int[][] pile = new int[][]{
                {0, 3, 0},
                {0, 3, 1},
                {0, 0, 0}};
    ...
    @Test
    void should_add_1_sand_grain_for_a_9_cells_with_3_grains_at_center_and_3_grains_around() {
        int[][] pile = new int[][]{
                {0, 3, 0},
                {3, 3, 3},
                {0, 3, 0}};
